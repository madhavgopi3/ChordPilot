...
function Callback(ev){
  ...
  gain.gain.setTargetAtTime(0.0,ev.t,0.000);
  gain.gain.setTargetAtTime(0,ev.g,0.000);
}
...
function setPresetSong()
{
  if(presetSong.value=="0"){
    ...
    pianoroll.setMMLString("t74o4l8r2.o5c4o4a4.r4ao5cdo4g4.r4.gab-4o5f4rfecdc16o4b-16a4r4.o5cddrd16r16g16fef16dc4r4o4fgao5dc4rco4b-a8.r16e4f4.");
    tempo.value="74";
    key.value="5";
  }
  if(presetSong.value=="1"){
    pianoroll.markend="128";
    pianoroll.setMMLString("t114o4l8o5d-4.e-4.o4a-4o5e-4.f4.a-16g-16fd-4.e-4.o4a-4.r2a-16a-16b-16o5d-8.d-4.e-4.o4a-4o5e-4.f4.a-16g-16fd-4.e-4.o4a-4.");
    tempo.value="114";
    key.value="1";
  }
...
function playClick()
{
 if (play.innerText=="Play") {  
      if(harmonizer){
        let totalTime = harmonizer.durationsPB.reduce((a, b) => a + b, 0)*15000/harmonizer.bpm;
        audio_ctx.resume();
        play.innerText = "Playing";
        pianoroll.play(audio_ctx, Callback);
        harmonizer.playChords();
        setTimeout(() => stopClick(),totalTime);
      }
   }
}
